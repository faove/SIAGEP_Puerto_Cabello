...
Begin VB.Form frm_est_presupuesto_ingreso_x_rubro 
   Caption         =   "Presupuesto de Ingreso por Rubro"
   ClientHeight    =   6435
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11085
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataGridLib.DataGrid DGrid_RUBROS 
         Bindings        =   "frm_est_presupuesto_ingreso_x_rubro.frx":0000
         Height          =   3615
         Left            =   120
         TabIndex        =   5
         Top             =   360
   ...
   End
End
Attribute VB_Name = "frm_est_presupuesto_ingreso_x_rubro"
...
sqlstr = "select * from TAB_RUBROS_INCIDENCIA where año = '" & frm_est_sel_año_rubro_presupuesto.txt_año.Year & "' " _
        & " and Cod_Rubro= '" & frm_est_sel_año_rubro_presupuesto.dcmb_rubro.BoundText & "'"
