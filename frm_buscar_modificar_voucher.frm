...
Begin VB.Form frm_buscar_modificar_voucher 
   Caption         =   "Modificar Monto Voucher"
   ClientHeight    =   3930
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7395
   ...
   End
End
Attribute VB_Name = "frm_buscar_modificar_voucher"
...
Select Case Index
    ...
    Case 0
        ...
        cn.Open "DSN=SIAGEP"
        sqlstr = "UPDATE ALC_OBJ_LIQS SET  monto_voucher = '" & STR(Me.TextBox(2).Text) & "' " _
           & " WHERE voucher = '" & Me.TextBox(0).Text & "'"
        cn.Execute sqlstr
        SCROLL 25
        SCROLL 41
    Case 1
