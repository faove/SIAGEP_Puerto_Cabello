...
Begin VB.Form rpt_cr_alc_rec_tiq_pic 
   Caption         =   "Planilla de Liquidación de Patente de Industria y Comercio"
   ClientHeight    =   5700
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6510
   ...
   End
End
Attribute VB_Name = "rpt_cr_alc_rec_tiq_pic"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New cr_alc_rec_tiq_pic
Dim Imprimio As Boolean

Private Sub Cerrar_Click()
Unload rpt_cr_alc_rec_tiq_pic
End Sub
