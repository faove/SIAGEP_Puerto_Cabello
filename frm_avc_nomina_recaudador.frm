...
Begin VB.Form frm_inf_avc_nomina_recaudador 
   Caption         =   "Nomina Diaria de Cancelaciones por Recaudador"
   ClientHeight    =   6615
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10185
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmd_imprimir 
         ...
         Left            =   5760
         TabIndex        =   5
         Tag             =   "Visualizar Nomina Diaria de Cancelaciones"
         Top             =   3960
         Width           =   1575
      End
      Begin MSDataListLib.DataList Dlist_recauda 
         Bindings        =   "frm_avc_nomina_recaudador.frx":0000
         Height          =   1815
         Left            =   3000
         TabIndex        =   2
         Top             =   480
      ...
      Begin MSDataListLib.DataList Dlist_tributo 
         Bindings        =   "frm_avc_nomina_recaudador.frx":001A
         Height          =   3960
         Left            =   240
         TabIndex        =   0
         Top             =   480
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Label Label22 
         BackColor       =   &H80000001&
         Caption         =   "NOMINA DIARIA DE CANCELACIONES"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   12
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_inf_avc_nomina_recaudador"
...
If Me.DList_tributo.Text = "" And Me.Cbox_todos.Value = False Then
    ...
    Exit Sub
End If
rpt_inf_avc_cancelaciones_x_recaudador.Show
End Sub
...
Private Sub Form_Load()
    txt_desde_año.Value = Format(Date, "dd/mm/yyyy")
    txt_hasta_año.Value = Format(Date, "dd/mm/yyyy")
End Sub
