...
Begin VB.Form frm_liquidacion_general 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frm_liquidacion_general.frx":0000
         Height          =   4095
         Left            =   0
         TabIndex        =   11
         TabStop         =   0   'False
   ...
   Begin MSAdodcLib.Adodc Adodc2 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "Get_Liq_General_Sfrm"
      Caption         =   "Adodc2"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   End
End
Attribute VB_Name = "frm_liquidacion_general"
...
.RecordSource = "SELECT * FROM Get_Liq_General_Sfrm WHERE ID_OBJ = '" & Gid_obj & "'"
.Refresh
End With
    
    
    frm_liquidacion_general.Caption = "Liquidación de " + Gid_Rubro_des
...
'    Me.Label2.Caption = "Nro. de Planilla: " & Nro_P
  ...
  Rem  Tex_Razon_Social = Grazon_social
    
  Rem  Tex_Razon_Social.Requery
  Rem  Tex_Id_Contri.Requery
...
Rem     Alc_Obj_Liqs!Renglon = Val(Tex_Cantidad)
   ...
   SCROLL 20
       ...
       SCROLL 35
        ...
        Me.Adodc3.Recordset!Rubro = CONCEPTO_SUB '301100106
