Attribute VB_Name = "AjustaPantalla"
    ...
    With MyForm
        For i = 0 To .Count - 1
            ...
            Select Case TypeName(.Controls(i))
                Case "ComboBox", "TextBox", "DTPicker", "CheckBox", "OptionButton"
...
Public Sub Ajusta(ByVal MyForm As Form)
...
Public Sub Reajusta(ByVal frm As Form)
