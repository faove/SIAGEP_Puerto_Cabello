...
Begin VB.Form rpt_alc_recaudacion_veh 
   Caption         =   "Planilla de Liquidación de Vehículo"
   ClientHeight    =   6345
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7110
   ...
   End
End
Attribute VB_Name = "rpt_alc_recaudacion_veh"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New cr_alc_recaudacion_veh

Private Sub Cerrar_Click()
Unload rpt_alc_recaudacion_veh
End Sub
